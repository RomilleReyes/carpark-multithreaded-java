...
public class CarparkServerThread extends Thread {
  ...
  private SharedCarparkState mySharedActionStateObject;
  private String myActionServerThreadName;
  private double mySharedVariable;
   
  //Setup the thread
  	public CarparkServerThread(Socket actionSocket, String ActionServerThreadName, SharedCarparkState SharedObject) {
